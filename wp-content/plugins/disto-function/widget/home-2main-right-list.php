...
add_action('widgets_init', 'disto_2main_right_list_widgets');

function disto_2main_right_list_widgets() {
    register_widget('disto_2main_right_listwidgets');
}

class disto_2main_right_listwidgets extends WP_Widget {
...
/*-----------------------------------------------------------------------------------*/
    ...
    public function __construct() {
        ...
        parent::__construct('disto_2main_right_listwidgets', esc_html__('jellywp: Home 2 main right list', 'disto'), $widget_ops);
    }
...
/*-----------------------------------------------------------------------------------*/
    function widget($args, $instance) {
        ...
        $post_per_cat = isset($instance['post_per_cat']) ? absint($instance['post_per_cat']) : 6;
    ...
    <?php }?>
<div class="jl_2main_rightlist_wrapper">
    ...
    <?php
        ...
        <div class="jl_2main_rightlist_wpin">      
...
$slider_large_image_header = wp_get_attachment_image_src( $slider_large_thumb_id, 'disto_slider_grid_large', true ); ?>
        ...
        <div class="jl_2main_rightlist_item jl_second_feature">
        <div class="jl_2main_rightlist_itemin">
        <?php $slider_large_thumb_id = get_post_thumbnail_id();
$slider_large_image_header = wp_get_attachment_image_src( $slider_large_thumb_id, 'disto_slider_grid_large', true ); ?>
        <?php if($slider_large_thumb_id){?>
...
<?php if(get_theme_mod('disable_post_category') !=1){
          ...
          if ($categories) {
            ...
            foreach( $categories as $tag) {
             ...
             if($title_reactions){}else{echo '<a class="post-category-color-text '.$tag->name.'" style="background:'.$title_bg_Color.'" href="'.esc_url($tag_link).'">'.$tag->name.'</a>';}
            }
            echo "</span>";
            }
            }
