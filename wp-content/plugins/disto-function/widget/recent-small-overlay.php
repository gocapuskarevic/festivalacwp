...
add_action( 'widgets_init', 'disto_recent_overlay_widgets' );

function disto_recent_overlay_widgets() {
    register_widget( 'disto_recent_overlay_widget' );
}

class disto_recent_overlay_widget extends WP_Widget {
...
/*-----------------------------------------------------------------------------------*/
    ...
    public function __construct() {
        ...
        parent::__construct('disto_recent_overlay_widget', esc_html__('jellywp: Recently Posts Overlay', 'disto'), $widget_ops);
    }
...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget($args, $instance) {
        ...
        // Post list in widget
        print '<div class="jl_recent_post_overlay">';
            $i = 0;
