...
add_action( 'widgets_init', 'disto_home_large_list_init' );

function disto_home_large_list_init() {
    register_widget( 'disto_home_large_list_widget' );
}

class disto_home_large_list_widget extends WP_Widget {
...
/*-----------------------------------------------------------------------------------*/
    ...
    public function __construct() {
        $widget_ops = array(
            'classname'   => 'disto_home_large_list_widget', 
            'description' => esc_html__('Display list post.', 'disto'),
            'panels_groups' => array('panels')
        );
        parent::__construct('disto_home_large_list_widget', esc_html__('jellywp: Home 1st large then list post', 'disto'), $widget_ops);
    }
...
/*-----------------------------------------------------------------------------------*/
    ...
    function form( $instance ) {
        $titles = isset($instance['titles']) ? esc_attr($instance['titles']) : 'Post large then list';
        $subtitle = isset($instance['subtitle']) ? esc_attr($instance['subtitle']) : '';
