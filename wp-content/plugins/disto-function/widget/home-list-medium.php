...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget($args, $instance) {
        ...
        echo '<div class="post_list_medium_widget jl_nonav_margin page_builder_listpost jelly_homepage_builder jl-post-block-'.esc_html($unique_block_id).'">';
        ...
        <div class="post-entry-content">
          ...
          if ($categories) {
            ...
            <div class="large_post_content">
                <p>
                    <?php $content = wp_trim_words( get_the_content(), 23, '...' );
