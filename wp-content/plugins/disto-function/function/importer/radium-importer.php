 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
    	...
    	public function intro_html() {
			...
			?>
			 ...
			 <?php
				...
				if ( $time_limit < 600 && $time_limit != 0 ) {
					$time_limit_message_html = ' <span class="configuration-error">WARNING: <strong>600</strong> value required.</span>';
					$hosting_passed = false;
				} else {
			...
			?>
			 <div class="theme-important-notice">
			 <p class="jl-infoset"><label><input type="checkbox" name="demo_import_content" value="1" id="demo_import_content" checked=""/> <strong>Import Demo Content</strong></label></p>
			 <p class="jl-infoset"><label><input type="checkbox" name="demo_import_widgets" value="1" id="demo_import_widgets" checked=""/> <strong>Import Widgets</strong></label></p>
			 <p class="jl-infoset"><label><input type="checkbox" name="demo_import_themeoptions" value="1" id="demo_import_themeoptions" checked=""/> <strong>Import Theme settings</strong></label></p>
			 </div>
			 ...
			 <div class="theme-demo-import-items">
				 <div class="theme-demo-import-item">
					 ...
					 <input type="radio" name="theme_demo" value="1" checked>Demo 1<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="2">Demo 2<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="3">Demo 3<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="4">Demo 4<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="5">Demo 5<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="6">Demo 6<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="7">Demo 7<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="8">Demo 8<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="9">Demo 9<br>
					 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="10">Demo 10<br>
					 </div>
			 ...
			 if( !empty($this->imported_demos) ) { ?>
			  		...
			  		<div class="import-description" style="background-color: #FAFFFB; margin:10px 0 30px;padding: 0px 10px;color: darkgreen;border: 1px solid #a1d3a2; clear:both; width:93%;">
			  		<p><?php echo wp_kses_post('You already launched demo data import before, but you can import demo content again. Some of your content (menus, etc) can be dublicated in this case. We recommend you to <a href="https://wordpress.org/plugins/wordpress-reset/" target="_blank">reset your WordPress</a> first. <b style="color:red">Note: reset WordPress will clear all your data in your website</b>'); ?></p>
			  	</div><?php
			   	//return;
	    ...
	    public function demo_installer() {
			...
			$(document).ready(function() {
				...
				$( ".check-import-log" ).on( "click", function() {
				...
				$('.radium-import-start').click(function(){
					...
					$( ".radium-importer-message" ).html( '<div class="theme-important-notice"><p>Importing demo data... Please wait, this process can take 1-5 minutes. Do not close your browser until process will finish.</p></div>' );

					$.get( "themes.php?page=radium_demo_installer&import_theme_demo="+theme_demo_value+"&demo_import_content="+demo_import_content+"&demo_import_widgets="+demo_import_widgets+"&demo_import_themeoptions="+demo_import_themeoptions+"&action=demo-data&demononce=<?php echo wp_create_nonce('radium-demo-code'); ?>", function( data ) {
					  $( ".radium-importer-message" ).html( '<div class="theme-important-notice"><p><span style="color: darkgreen;"><strong>Demo data was imported succesfully.</strong></span><br>Any real images that may be imported with demo data are just examples and you do not have legal rights to use these images on your website, you must replace these images with your own.</p></div><div class="theme-important-notice"><p>You can <a class="check-import-log" style="cursor: pointer;">check import log</a> if you think your website looks incorrectly after demo data import.</p><div class="import-log-text" style="display: none;">' + $(data).find(".radium-importer-message").html() + '</div>' );
					});
				});
	    ...
	    public function set_demo_theme_options( $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				if( $this->theme_options_framework == 'radium') {
				...
				} elseif( $this->theme_options_framework == 'customizer' ) {

					$data = unserialize( $data );

					// Save theme mods
					foreach ( $data['mods'] as $key => $val ) {
						if($key !== 'nav_menu_locations') { // Don't assign menus
							set_theme_mod( $key, $val );
						}
					}

					// Reset caches
		            update_option( 'themeoptions_saved_date', 1, 'no' );
		            update_option( 'editor_cache_css_saved_date', 0, 'no' );
		            update_option( 'cache_css_saved_date', 0, 'no' );

		            // Remove editor CSS cache files
		            WP_Filesystem();
			        ...
			        $wp_filesystem->delete( $css_editor_cache_file );
	    ...
	    public function import_widgets( $data ) {
	    	...
	    	foreach ( $data as $sidebar_id => $widgets ) {
	    		...
	    		foreach ( $widgets as $widget_instance_id => $widget ) {
	    			...
	    			if(!empty($results[$sidebar_id]['widgets'][$widget_instance_id]['title'])) {
