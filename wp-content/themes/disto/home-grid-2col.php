...
?>
<div class="jl_post_loop_wrapper jl_grid_4col_home jl_grid_large2col">
    ...
    while ( $disto_qry->have_posts() ) { 
       $disto_qry->the_post();
        $disto_post_id = $post->ID;                     
                    ...
                    get_template_part( 'inc/post-formats/grid-large/content', get_post_format() );
                    }}else{                               
