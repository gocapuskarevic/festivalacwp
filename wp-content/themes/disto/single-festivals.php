...
<section id="content_main" class="clearfix jl_spost">
    ...
    echo '<br>';
    the_field('end_date');
    echo '<div style="width:500px;">'.the_field('youtube_link').'</div>';
    ?>
    <img src="<?php the_field('announcement_poster'); ?>" width="350px">
    <a href="<?php the_field('tickets'); ?>">Karte</a>
    <a href="<?php the_field('official_website'); ?>">Festivalski websajt</a>
        <?php the_field('custom_link'); ?>
        <?php the_field('text_for_the_official_website'); ?>
    <div class="container">
        <div class="row main_content">
            <div class="<?php echo "col-md-12 enable_single_post_full "; ?> loop-large-post" id="content">
